...
class UserTest < Test::Unit::TestCase
  ...
  context 'A user' do
    ...
    should_allow_values_for :url, 'http://example.com', 'https://example.com'
    should_not_allow_values_for :url, 'example.com', 'ftp://example.com', :message => 'is geen geldige <abbr>URL</abbr>, een geldige <abbr>URL</abbr> begint met http://'
    
    should_allow_values_for :email, 'john@example.com', 'john.doe@example.com'
    should_not_allow_values_for :email, 'john', 'john @ example.com', :message => 'is geen geldig e-mail adres'
    ...
    context 'being remembered until 1 week from now' do
      setup do
